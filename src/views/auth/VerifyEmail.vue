    ...
    <b-row class="m-0 align-items-center bg-white vh-100">
      <b-col md="6 p-0">
        <b-card class="card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
          <router-link :to="{ name: 'admin.dashboard' }" class="navbar-brand d-flex align-items-center mb-3 text-primary">
          ...
          <div class="d-inline-block w-100">
            <router-link :to="{ name: 'admin.dashboard' }" class="btn btn-primary mt-3">Back to Home</router-link>
          </div>
        </b-card>
      </b-col>
