      ...
      <div class="col">
        <div class="card mb-3">
            ...
            <ul class="nav nav-tabs card-header-tabs" role="tablist">
              <li class="nav-item">
                <button
                  ...
                  data-bs-toggle="tab"
                  data-bs-target="#form-tabs-mobile-user"
                  role="tab"
                  aria-selected="true"
                >
                  Mobile User
          ...
          <div class="tab-content">
            <!-- Personal Info -->
            <div class="tab-pane fade active show" id="form-tabs-mobile-user" role="tabpanel">
              <form>
                <div class="row g-3">
                  <div class="col-md-6">
                    <div class="row">
                ...
                <div class="row mt-4">
                  <div class="col-md-6">
                    <div class="row justify-content-end">
                      <div class="col-sm-9">
                        <button class="btn btn-info me-sm-3 me-1">APK DOWNLOAD LINK</button>
                        <button class="btn btn-warning me-sm-3 me-1">RESET</button>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="tab-pane fade" id="form-tabs-account" role="tabpanel">
              <form>
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-email"
                        >Email</label
                      >
                      <div class="col-sm-9">
