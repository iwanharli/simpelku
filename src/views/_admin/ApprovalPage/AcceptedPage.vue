<template>
  <div class="containerPage bg-info p-5" style="padding-top: 40px !important">
    <b-row>
      <b-col xl="12" lg="12" md="12" sm="12" class="bg-soft-secondary mb-3 p-4" style="border-radius: 20px; border: 3px solid white" data-aos="fade-down" data-aos-delay="110">
        <div class="header-title">
          <b-row>
            ...
            <b-col xl="3" lg="4" md="5" sm="5" class="d-flex justify-content-end">
      ...
      <b-col xl="12" lg="12" md="12" sm="12">
        <div class="table-responsive bg-light" style="border-radius: 20px; border: 3px solid white" data-aos="fade-up" data-aos-delay="110">
          <table id="basic-table" class="table table-condensed mb-0" role="grid">
            <thead>
