<template>
  <div class="containerPage bg-danger p-5" style="padding-top: 40px !important">
    <b-row>
      <b-col xl="12" lg="12" md="12" sm="12" class="bg-soft-secondary mb-3 p-4" style="border-radius: 20px; border: 3px solid white" data-aos="fade-down" data-aos-delay="110">
      ...
      <b-col xl="12" lg="12" md="12" sm="12">
        <div class="table-responsive bg-light" style="border-radius: 20px; border: 3px solid white" data-aos="fade-up" data-aos-delay="110">
          <table id="basic-table" class="table table-border mb-0" role="grid">
            ...
            <tbody>
              <tr v-for="(item, index) in filteredRejectedData" :key="index++">
                ...
                <td class="bg-soft-dark">
                  <a :href="getWhatsAppLink(item.phone)" class="btn btn-sm btn-success text-start p-2" style="width: 100%" type="button" target="_blank"> <img src="@/assets/images/whatsapp.png" width="20" height="20" /> &nbsp; {{ item.phone }} </a>
                </td>
              </tr>
            </tbody>
          </table>
